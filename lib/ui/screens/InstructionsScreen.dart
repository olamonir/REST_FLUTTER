                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                                        children: <Widget>[
                                          ...
                                          child:Container(
                                            ...
                                            child:Text(
                                          Translations.of(context).text('instructions' ) ,                  
                                          ...
                                          child:Container(
                                            margin: EdgeInsets.only(top : 30, bottom: 10),child: Text(
                                          Translations.of(context).text('instructions' ) ,                  
                                          style:TextStyle(color: Colors.white) ,
                                          textAlign: TextAlign.center,
                                        )
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                                        children: <Widget>[
                                          ...
                                          Center(
                                           ...
                                           child:  Text(Translations.of(context).text('instructions_content' ) , style: TextStyle(
                                                  color: Colors.grey,
